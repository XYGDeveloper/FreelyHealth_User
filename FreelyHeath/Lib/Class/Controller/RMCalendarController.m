...
- (UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView cellForItemAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    cell.model = model;
    if (model.ticketModel.ticketPrice) {
        cell.chineseCalendar.textColor = [UIColor lightGrayColor];
        cell.dayLabel.textColor = [UIColor lightGrayColor];
        cell.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"CalendarDisableDate"]];
    }
    return cell;
}
