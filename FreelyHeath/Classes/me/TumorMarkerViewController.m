...
@interface TumorMarkerViewController ()<UITableViewDelegate,UITableViewDataSource,ApiRequestDelegate>
...
@implementation TumorMarkerViewController
...
- (void)refreshHead{
    ...
    self.element.text = self.model.name;
...
- (void)setHeadView{
    ...
    self.element.font = Font(16);
    
    self.element.textColor = [UIColor whiteColor];
    
    self.element.textAlignment = NSTextAlignmentCenter;
    
    [self.secondWare addSubview:self.element];
    ...
    self.dateStringLabel.text = @"2017-07-24";
...
- (void)layOutSubView{
    ...
    [self.weightLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.element.mas_bottom);
