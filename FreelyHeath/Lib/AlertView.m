...
- (void)createMessageView {
    ...
    if (title) {
       titleLabel.frame= CGRectMake(0, 15, 250, 20);
        ...
        titleLabel.font = FontNameAndSize(16);
    ...
    textLabel.text          = text;
    textLabel.font          = FontNameAndSize(16);
    textLabel.textColor     =DefaultGrayTextClor;
    ...
    if (message.buttonsTitle.count) {
        ...
        for (int i = 0; i < message.buttonsTitle.count; i++) {
            ...
            UIColor *normalColor      = (style.style == kAlertViewRedStyle ?AppStyleColor : [UIColor blackColor]);
            ...
            button.titleLabel.font        = (style.style == kAlertViewRedStyle ?
                                             FontNameAndSize(14) : FontNameAndSize(14));
