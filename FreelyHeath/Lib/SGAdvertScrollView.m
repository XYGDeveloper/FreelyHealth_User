...
- (UILabel *)topLabel {
    if (!_topLabel) {
        ...
        _topLabel.font = FontNameAndSize(14);
...
- (UILabel *)bottomLabel {
    if (!_bottomLabel) {
        ...
        _bottomLabel.font = FontNameAndSize(14);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.advertScrollViewStyle == SGAdvertScrollViewStyleMore) {
        ...
        if (self.titleFont) {
            cell.topLabel.font = FontNameAndSize(14);
            cell.bottomLabel.font = FontNameAndSize(14);
        }

        if (self.topTitleColor) {
            cell.topLabel.textColor = DefaultGrayTextClor;
        }
        if (self.bottomTitleColor) {
            cell.bottomLabel.textColor = DefaultGrayTextClor;
        }
        return cell;
        ...
        if (self.titleFont) {
            cell.titleLabel.font = FontNameAndSize(14);
        }
        if (self.titleColor) {
            cell.titleLabel.textColor = DefaultGrayTextClor;
        }
        return cell;
    }
}
