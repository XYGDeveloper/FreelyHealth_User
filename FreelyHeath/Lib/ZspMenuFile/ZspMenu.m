...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        _selectedTextColor = AppStyleColor;
        ...
        //初始化两个tableView
        _leftTableView = [[UITableView alloc] initWithFrame:CGRectMake(origin.x, origin.y + self.frame.size.height, SCREEN_WIDTH / 2, 0) style:UITableViewStyleGrouped];
        _leftTableView.delegate = self;
        _leftTableView.dataSource = self;
        _leftTableView.rowHeight = kTableViewCellHeight;
        _leftTableView.separatorColor = kSeparatorColor;
        
        _rightTableView = [[UITableView alloc] initWithFrame:CGRectMake(origin.x + SCREEN_WIDTH / 2, origin.y + self.frame.size.height, SCREEN_WIDTH / 2, 0) style:UITableViewStyleGrouped];
