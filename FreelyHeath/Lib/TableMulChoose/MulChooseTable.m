...
-(void)CreateTable{
    ...
    _MyTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth,kScreenHeight - 40-64-64)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    GroupConSearchModel *model = [_dataArr objectAtIndex:indexPath.row];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell.isSelected) {
        [_choosedArr addObject:model.did];
    }
    else{
        [_choosedArr removeObject:model.did];
    }
