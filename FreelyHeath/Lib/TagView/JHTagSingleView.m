...
- (UIButton *)removeBtn{
    if (!_removeBtn) {
        _removeBtn = [[UIButton alloc]initWithFrame:CGRectMake(self.bounds.size.width - 26/2-10, CGRectGetMidY(_tagBtn.frame), 22/2, 22/2)];
        [_removeBtn setBackgroundImage:[UIImage imageNamed:@"tag_del"] forState:UIControlStateNormal];
