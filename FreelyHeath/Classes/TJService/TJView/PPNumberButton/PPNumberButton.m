...
- (void)increase {
    ...
    if (number <= _maxValue) {
        ...
        self.decreaseImage = [UIImage imageNamed:@"amout_mul"];
        self.increaseImage = [UIImage imageNamed:@"amout_add"];
    } else {
        self.increaseImage = [UIImage imageNamed:@"amout_addgray"];
...
//            [self rotationAnimationMethod];
        ...
        self.decreaseImage = [UIImage imageNamed:@"amout_gray"];
    }
}
...
- (void)checkTextFieldNumberWithUpdate {
    ...
    if ([_textField.text pp_isNotBlank] == NO || _textField.text.integerValue < _minValue || _textField.text.integerValue == 1) {
    ...
    if (_textField.text.integerValue > _maxValue) {
        ...
        self.increaseImage = [UIImage imageNamed:@"amout_addgray"];
        [Utils postMessage:@"最大购买500件哦" onView:[UIApplication sharedApplication].delegate.window];
    }
}
