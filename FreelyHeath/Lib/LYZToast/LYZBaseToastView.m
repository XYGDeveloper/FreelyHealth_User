...
-(void)layoutToastView{
    ...
    self.toastBackgroundColor = AppStyleColor;
    self.iconImageSize = self.iconImage == nil ? CGSizeZero : CGSizeMake(35.f, 35.f);
...
-(void)layoutSubviews{
    ...
    CGFloat messageLabelX = kScreenWidth/2.0;
    ...
    if (self.titleString == nil) {
        ...
        messageLabelW = kScreenWidth - 2*HORIZONTAL_SPACE;
    }else{
        messageLabelY = titleLabelY;
        messageLabelW = kScreenWidth/2.0 - HORIZONTAL_SPACE;
    }
