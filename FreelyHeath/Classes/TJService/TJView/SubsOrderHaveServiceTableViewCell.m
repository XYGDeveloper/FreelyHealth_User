//
//  SubsOrderHaveServiceTableViewCell.m
//  FreelyHeath
//
...
@interface SubsOrderHaveServiceTableViewCell()
...
@property (nonatomic,strong)UILabel *servicePay;
@property (nonatomic,strong)UILabel *servicePayCon;
@end
@implementation SubsOrderHaveServiceTableViewCell
...
- (UILabel *)servicePay{
    if (!_servicePay) {
        _servicePay = [[UILabel alloc]init];
        _servicePay.text = @"服 务 费:";
        _servicePay.textColor = DefaultBlackLightTextClor;
        _servicePay.font =FontNameAndSize(14);
        _servicePay.textAlignment = NSTextAlignmentLeft;
    }
    return _servicePay;
}
...
- (UILabel *)servicePayCon{
    if (!_servicePayCon) {
        _servicePayCon = [[UILabel alloc]init];
        _servicePayCon.textColor = AppStyleColor;
        _servicePayCon.font =FontNameAndSize(14);
        _servicePayCon.textAlignment = NSTextAlignmentLeft;
    }
    return _servicePayCon;
}
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.contentView addSubview:self.namecon];
        [self.contentView addSubview:self.telephonecon];
        ...
        [self.contentView addSubview:self.servicePay];
        [self.contentView addSubview:self.servicePayCon];
        ...
        [self.servicePay mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(20);
        ...
        [self.orderSum mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(20);
            make.top.mas_equalTo(self.servicePay.mas_bottom).mas_equalTo(10);
            make.width.mas_equalTo(90);
            make.height.mas_equalTo(15.5);
        }];
        ...
        [self.status mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(20);
            make.top.mas_equalTo(self.telephone.mas_bottom).mas_equalTo(10);
            make.width.mas_equalTo(90);
            make.height.mas_equalTo(15.5);
        ...
        [self.servicePayCon mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self.servicePay.mas_right);
            make.top.mas_equalTo(self.count.mas_bottom).mas_equalTo(10);
            make.right.mas_equalTo(0);
            make.height.mas_equalTo(15.5);
        }];
        ...
        [self.namecon mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self.name.mas_right);
            make.top.mas_equalTo(self.orderRealPayCon.mas_bottom).mas_equalTo(10);
            make.right.mas_equalTo(0);
            make.height.mas_equalTo(15.5);
        }];
        [self.telephonecon mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self.telephone.mas_right);
            make.top.mas_equalTo(self.name.mas_bottom).mas_equalTo(10);
            make.right.mas_equalTo(0);
            make.height.mas_equalTo(15.5);
        }];
...
- (void)refreshWithModel:(TJOrderDetailModel *)model
{
    ...
    if (!model.count) {
        self.countCon.text = [NSString stringWithFormat:@"%d",1];
    }else{
        self.countCon.text = [NSString stringWithFormat:@"%d",model.count];
    }
    ...
    if (model.count >= 10) {
        self.servicePayCon.text = [NSString stringWithFormat:@"￥%@",@"0"];
    }else{
        self.servicePayCon.text = [NSString stringWithFormat:@"￥%@",@"300"];
    }
